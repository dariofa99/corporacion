                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <img src="{{ asset('dist/img/Logo_horizontal.png') }}"
                                                                        alt
                                                                        style="display:block;height:70px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="120">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        <small>Powered by Amatai. Ingeniería informática
                                                                            SAS
                                                                            &copy;{{ date('Y') }}</small>
                                                                    </p>
                                                                </td>
