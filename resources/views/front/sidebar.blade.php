...
<a  href="{{ route('logout') }}"
      ...
      {{--     <li class="nav-item has-treeview menu-open">
          ...
          <li class="nav-item">
            <a href="{{route('office.reception',session('session_reception')->id)}}" class="nav-link {{active('oficina/chat/view')}}">
              <i class="nav-icon fa fa-comments "></i>
              <p>
                Chat
                <span id="lbl_chatCountUsers" class=" lbl_chatCountUsers right badge badge-success">0</span>
              </p>
            </a>
          </li> 
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="{{route('office.notification')}}" class="nav-link {{active('oficina/notificaciones/view')}}">
              <i class="nav-icon fa fa-info-circle"></i>
              <p>
                Notificaciones
                <span class="badge badge-info right">{{count(session('session_case')->logs()->where('type_log_id',23)->get())}}</span>
              </p>
            </a>
          </li> 
        ...
        <li class="nav-item">
            <a href="{{route('office.diary')}}" class="nav-link {{active('oficina/diary/view')}}">
              ...
              <p>
                Agenda
                <span class="badge badge-info right">{{count(auth()->user()->diarys()->where('inicio', '>=', date('Y-m-d H:i:s'))->get())}}</span>
              </p>
            </a>
        </li>
        ...
        <li class="nav-item has-treeview ">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item ml-3">
              <a href="{{route('office.alerts')}}" class="nav-link">
            ...
            <li class="nav-item ml-3">
              <a href="{{route('office.directories')}}" class="nav-link">
