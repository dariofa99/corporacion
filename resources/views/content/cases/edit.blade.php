...
@section('content')
    ...
    <section class="content">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active urlactive" id="chat-tab" data-toggle="tab" href="#chat_tab"
                                        role="tab" aria-controls="chat_tab" aria-selected="false">
                                        Oficina virtual
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link urlactive" id="users-client" data-toggle="tab" href="#users_client"
                                        role="tab" aria-controls="users_client" aria-selected="false">
                                        Datos solicitante
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link urlactive" id="case-data" data-toggle="tab" href="#case_data" role="tab"
                                        aria-controls="case_data" aria-selected="true">
                                        Datos del caso
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link urlactive" id="log-tab" data-toggle="tab" href="#log_tab" role="tab"
                                        aria-controls="log_tab" aria-selected="false">
                                        Bitácora
                                    </a>
                                </li>
                                <!--
     ...
     -->
                                <li class="nav-item">
                                    <a class="nav-link urlactive" id="assignment-tab" data-toggle="tab" href="#assignment_tab"
                                        role="tab" aria-controls="assignment_tab" aria-selected="false">
                                        Asignaciones
                                    </a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="chat_tab" role="tabpanel"
                                    ...
                                    <div class="row content_log_data">
                                        ...
                                        <div class="col-md-4">
                                            <button class="btn btn-primary btn-sm btn-block btn_get_logs" data-type_id="18"
                                                id="btnViewDocuments">
                                                <i class="fas fa-folder-open"> </i> Documentos </button>
                                            <br>
                                            <button class="btn btn-warning btn-sm btn-block btn_get_logs" data-type_id="23"
                                                id="btnViewNotifications">
                                                <i class="fa fa-info-circle"> </i> Notificaciones</button>
                                            <br>
                                            <button class="btn btn-info btn-sm btn-block" data-type_id=""
                                                id="btnViewStreaming">
                                ...
                                <div class="tab-pane fade " id="case_data" role="tabpanel"
                                    aria-labelledby="case-data-tab">
                                    @include('content.cases.partials.general_data')
                                    @include('content.cases.partials.data')
                                </div>

                                <div class="tab-pane fade " id="users_client" role="tabpanel"
                                    aria-labelledby="users-client-tab">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#chat_tab").on("click", '#btnViewStreaming', function(e) {
                ...
                $('#newtab-stream-cases').attr('href', 'https://meet.jit.si/lybra_{{ sha1($case->id) }}?jwt=eyJraWQiOiJqaXRzaS1tb2RlcmF0ZWQtcHJvZC0yMDIxLTA2LTA0IiwiYWxnIjoiUlMyNTYiLCJ0eXAiOiJKV1QifQ..mH1cjNFwisx1D7S0UtZuWfPq2DqJCdNPOjiJ1MMXsiUZtrIoi-2PB5HGZqsl9BJsNTrEmWmCIBbUw9f0hBtMi0d3hbIYJ5aZQ8Kuvq4nqRwhaqaZTAT_lapQ5ib8Y1-vCWxtlthnCrA22XS0WRfRzcepy6voqlKZZV8Lbau-fQQBwU9rOx841ie8f5uR0Wljvazpj2aMO76uLci9S2dAOkYnfrgXcKyOabt-uguwQXo5uN4k2UARRT5Tq7H6KY4o8WCKIAMgqEjxSbFnowq-fqNpGQDmKMxhWFisgGQmu3JM01S1bK6HObIzhDA4bxfiibLxby0XLo15WBqnWfUeCw');
                $('#copy-stream-cases').attr('data-frame',
                    'https://meet.jit.si/lybra_{{ sha1($case->id) }}');
                $('#text-stream-cases').val('https://meet.jit.si/lybra_{{ sha1($case->id) }}');
                $('#text-stream-cases-moderator').val('https://meet.jit.si/lybra_{{ sha1($case->id) }}?jwt=eyJraWQiOiJqaXRzaS1tb2RlcmF0ZWQtcHJvZC0yMDIxLTA2LTA0IiwiYWxnIjoiUlMyNTYiLCJ0eXAiOiJKV1QifQ..mH1cjNFwisx1D7S0UtZuWfPq2DqJCdNPOjiJ1MMXsiUZtrIoi-2PB5HGZqsl9BJsNTrEmWmCIBbUw9f0hBtMi0d3hbIYJ5aZQ8Kuvq4nqRwhaqaZTAT_lapQ5ib8Y1-vCWxtlthnCrA22XS0WRfRzcepy6voqlKZZV8Lbau-fQQBwU9rOx841ie8f5uR0Wljvazpj2aMO76uLci9S2dAOkYnfrgXcKyOabt-uguwQXo5uN4k2UARRT5Tq7H6KY4o8WCKIAMgqEjxSbFnowq-fqNpGQDmKMxhWFisgGQmu3JM01S1bK6HObIzhDA4bxfiibLxby0XLo15WBqnWfUeCw');
            ...
            $("#myModal_create_streaming_cases").on("click", '#copy-stream-cases-moderator', function(e) {

                copiarAlPortapapeles('content-text-stream-cases-moderator');
