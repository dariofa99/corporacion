    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" data-type_id="140"
                    class="form-control form-control-sm input_change_case_data set_old_value"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="124"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(124)) value="{{ $case->getCaseData(124)->value }}" @endif
                    placeholder="Ej: Segundo Rosero">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="125"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(125)) value="{{ $case->getCaseData(125)->value }}" @endif
                    placeholder="Ej: 568548965">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="126"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(126)) value="{{ $case->getCaseData(126)->value }}" @endif
                    placeholder="Ej: 3105489650">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="127"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(127)) value="{{ $case->getCaseData(127)->value }}" @endif
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="128"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(128)) value="{{ $case->getCaseData(128)->value }}" @endif
                    placeholder="Ej: Corazón de Jesús">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="129"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(129)) value="{{ $case->getCaseData(129)->value }}" @endif
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" data-type_id="130"
                    class="form-control form-control-sm input_change_case_data set_old_value"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="131"
                    class="form-control form-control-sm input_case_data set_old_value"
                    @if ($case->getCaseData(131)) value="{{ $case->getCaseData(131)->value }}" @endif
                    placeholder="Ej: 5">
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <input type="text" data-type_id="12"
                    class="form-control form-control-sm input_case_data set_old_value" name="depto" id="depto"
                    @if ($case->getCaseData(12)) value="{{ $case->getCaseData(12)->value }}" @endif
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="13"
                    class="form-control form-control-sm input_case_data set_old_value" name="municipio" id="municipio"
                    @if ($case->getCaseData(13)) value="{{ $case->getCaseData(13)->value }}" @endif
                    placeholder="Ej: San Juan de Pasto">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" data-type_id="17"
                    class="form-control form-control-sm input_case_data set_old_value" name="juzgado" id="juzgado"
                    @if ($case->getCaseData(17)) value="{{ $case->getCaseData(17)->value }}" @endif
