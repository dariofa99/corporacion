                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="nav-bill-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="link-general-bill-tab" data-toggle="pill"
                                    href="#general-bill-tab" role="tab" aria-controls="general-bill-tab"
                                    aria-selected="true">
                                    General</a>
                            </li>
                            <li class="nav-item optionsnav">
                                <a class="nav-link" id="link-value-bill-tab" data-toggle="pill" href="#value-bill-tab"
                                    role="tab" aria-controls="value-bill-tab" aria-selected="false">
                                    Valor</a>
                            </li>
                    ...
                    Opciones</a>
                            ...
                            <li class="nav-item optionsnav">
                                <a class="nav-link" id="link-support-bill-tab" data-toggle="pill" href="#support-bill-tab"
                                    role="tab" aria-controls="support-bill-tab" aria-selected="false">
                                    Soportes</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="tabs-bill-content">
                            ...
                            <div class="tab-pane fade show active" id="general-bill-tab" role="tabpanel"
                                aria-labelledby="general-bill-tab">
                                <form action="#" method="POST" id="myformEditBill" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group bill_r">
                                        ...
                                        <select name="type_category_id" required="" class="form-control form-control-sm"
                                            id="type_categorybill_id">
                                    ...
                                    <div class="form-group bill_r">
                                        ...
                                        <input type="text" required=""
                                            class="form-control form-control-sm input_payment_value" id="concept"
                                            name="concept">
                                    </div>

                                    <div class="form-group">
                                        <label for="email">Descripción</label>
                                        <textarea required="" class="form-control form-control-sm input_payment_value" name="description" id="description"
                                            rows="3"></textarea>
                                    ...
                                    <div class="form-group bill">
                                        ...
                                        <input type="checkbox" class="chk_payment_value" name="shared" id="shared_bill"
                                            data-size="xs" data-style="order-check" data-width="60" data-toggle="toggle"
                            ...
                            <div class="tab-pane fade" id="value-bill-tab" role="tabpanel" aria-labelledby="value-bill-tab">
                                <form action="" method="POST" id="myformEditBillCredits">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" required="" class="form-control form-control-sm set_val_pcv"
                                            id="value" name="value" value="">
                                    </div>
                                    <div class="form-group bill_r">
                                        <label for="type_payment_id">Tipo pago</label>
                                        <select name="type_payment_id" required="" class="form-control form-control-sm"
                                            id="type_payment_id">
                                            <option value="">Seleccione..</option>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" required=""
                                                    class="form-control form-control-sm set_val_pcv" id="num_payments"
                                                    name="num_payments" value="">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="type_periodpay_id">Periodo de cuota</label>
                                                <select name="type_periodpay_id" required=""
                                                    class="form-control form-control-sm" id="type_periodpay_id">
                                                    <option value="">Seleccione..</option>
                                    ...
                                    <div class="row credit_options">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly name="pay_credit_value" id="pay_credit_value"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="date" min="{{ date('Y-m-d') }}" name="limit_payment_date"
                                                    id="limit_payment_date" required=""
                                    ...
                                    <div class="row mp_options">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <select name="payment_method_id" required disabled
                                                    class="form-control form-control-sm payment_method_id"
                                    ...
                                    <div class="form-group des_mp" style="display:none">
                                        ...
                                        <textarea class="form-control form-control-sm" disabled required name="description_pmethod" id="description_pmethod"
                                            rows="4"></textarea>
                                    </div>
                                    <div class="form-group des_url_pay" style="display:none">
                                        <label for="value">URL</label>
                                        <input class="form-control form-control-sm" type="url" name="description_pmethod"
                                            id="url_description_pmethod" value="https://biz.payulatam.com/"
                                            placeholder="https://biz.payulatam.com/" pattern="https://biz.payulatam.com/.*"
                                            size="30" required>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="support-bill-tab" role="tabpanel"
                                aria-labelledby="support-bill-tab">
                                ...
                                <div class="row" style="display:none;margin-bottom:4px;" id="content_form_support_file">
                                    ...
                                    <div class="col-md-12" id="cont_bill_files_upload">
                                        ...
                                        <div class="table table-striped files" id="previews_bill_files"
                            ...
                            <div class="tab-pane fade" id="options-bill-tab" role="tabpanel"
                                aria-labelledby="options-bill-tab">
