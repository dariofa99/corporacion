@component('components.modal_medium')
    ...
    @slot('title')
        <h6><label id="lbl_modal_title">Nueva Actuación</label></h6> <span
            style="margin-left:15px;margin-top: -3px;">{{ date('Y-m-d') }}</span>
    @endslot
                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active btn_datos" id="custom-tabs-data-tab" data-toggle="pill"
                                        href="#custom-tabs-data" role="tab" aria-controls="custom-tabs-data"
                                        aria-selected="true">
                                        Datos</a>
                                </li>
                                <li class="nav-item optionsnav">
                                    <a class="nav-link" id="custom-tabs-files-tab" data-toggle="pill" href="#custom-tabs-files"
                                        role="tab" aria-controls="custom-tabs-files" aria-selected="false">
                                        Archivos</a>
                                </li>
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-data" role="tabpanel"
                                    aria-labelledby="custom-tabs-data-tab">

                                    <div class="form-group log_r">
                                        <label for="concept">Fecha radicado</label>
                                        <input type="date" required class="form-control form-control-sm" id="filing_date"
                                            name="filing_date">
                                    </div>
                                    ...
                                    <div class="form-group log_r">
                                        ...
                                        <input type="hidden" placeholder="Nueva categoria" name="category_name"
                                            id="category_name" style="margin-top:2px" class="form-control form-control-sm"
                                            id="concept" name="concept">
                                    </div>

                                    <div class="form-group log_r">
                                        <label for="concept">Concepto</label>
                                        <input type="text" required class="form-control form-control-sm" id="concept"
                                            name="concept">
                                    </div>
                            ...
                            <div class="custom-file">
                                ...
                                <div class="tab-pane fade" id="custom-tabs-files" role="tabpanel"
                                    aria-labelledby="custom-files-tab">





                                    <div class="row" style="display:block;margin-bottom:4px;"
                                        id="content_form_support_file_log">
                                        <div class="col-12">
                                            <div id="actions_upload_logs">
                                                ...
                                                <button type="reset" style="display:none"
                                                    class="btn btn-sm btn-default start">
                                                    <i class="fa fa-window-close-o"></i>
                                                    <span> start</span>
                                                </button>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-options" role="tabpanel"
                                    ...
                                    <div class="form-group log_r">
                                        ...
                                        <input type="checkbox" name="shared" id="shared_log" data-size="xs"
                                            data-style="order-check" data-width="60" data-toggle="toggle" data-on="Si"
                                            data-off="No" data-onstyle="success" data-offstyle="danger">
                                    </div>
                                    <div class="form-group log_r">
                                        <label for="support_docs">¿Es documento de apoyo?</label>
                                        <input type="checkbox" id="support_docs" name="support_docs" data-size="xs"
                                            data-style="order-check" data-width="60" data-toggle="toggle" data-on="Si"
                                            data-off="No" data-onstyle="success" data-offstyle="danger">
                                    </div>
                                    <div class="form-group log_r">
                                        <label for="support_docs">¿Activar recordatorio?</label>
                                        <input type="checkbox" id="recordatory" name="recordatory" data-size="xs"
                                            data-style="order-check" data-width="60" data-toggle="toggle" data-on="Si"
                                            data-off="No" data-onstyle="success" data-offstyle="danger">
                                    </div>
                                    <div class="form-group log_r recordatoryclass" style="margin-left: 20px;">
                                        <label for="date">Fecha recordatorio</label>
                                        <input type="datetime-local" disabled name="notification_date"
                                            id ="notification_date" required class="form-control form-control-sm"
                                            value="">
                                    </div>
                                    <div class="form-group log_r recordatoryclass" style="margin-left: 20px;">
                                        <label for="support_docs">¿Mostrar en agenda?</label>
                                        <input type="checkbox" id="share_on_diary" name="share_on_diary" data-size="xs"
                                            data-style="order-check" data-width="60" data-toggle="toggle" data-on="Si"
                                            data-off="No" data-onstyle="success" data-offstyle="danger">
                                    </div>
                                </div>
    ...
    @slot('footer')
        <button type="button" class="btn btn-secondary btn_close_modal" data-modal="myModal_create_log"
