  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p align="center">Aún no hay suficientes datos para generar el informe. <br>
        Lo invitamos a ver algunos gráficos de ejemplo:
        
         </p>
      </div>
      <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="show();">Aceptar</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Gráfico Barras Apiladas</h3>
