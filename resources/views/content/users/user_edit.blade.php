                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="card card-primary card-outline">
                                                <div class="card-body box-profile">
                                                    <div class="text-center" style="position:relative !important">
                                                        @if ($canedit)
                                                            <div id="change_photo"><i class="fa fa-camera"></i></div>
                                                        @endif
                                                        <img id="image_profile"
                                                            class="profile-user-img img-fluid img-circle"
                                                            src="{{ asset($user->image) }}" alt="User profile picture">
                                                        <div class="progress" style="margin-top:2px;display:none"
                                                            id="progress_bar">
                                                            <div class="progress-bar" role="progressbar" style="width: 55%"
                                                                aria-valuenow="45" aria-valuemin="0" aria-valuemax="100">25%
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <h3 id="lbl_user_p_name"
                                                        class="profile-username text-center lbl_user_name">
                                                        {{ $user->name }}</h3>
                                            ...
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    ...
                                                    <div class="float-right">
                                                        @if ($canedit and auth()->user()->can('crear_categorias'))
                                                            <i class="fa fa-plus-circle btn_add_data_user"
                                                                title="Agregar campo" data-section="about_me"
                                                                id="btn_add_am_data_user"></i>
                                                        @endif
                                                    </div>
                                                </div>
                                                <!-- /.card-header -->
                                                <div class="card-body setOlderValue" id="content_user_data_about_me">
                                                    @include(
                                                        'content.users.partials.ajax.about_me_component',
                                                        [
                                                            'user' => $user,
                                                        ]
                                                    )
                                                    ...
                                                    <div class="tab-content">
                                                                    ...
                                                                    <div class="form-group">
                                                                        @if ($canedit and auth()->user()->can('crear_categorias'))
                                                                            <button title="Agregar campo"
                                                                                data-section="case"
                                                                                id="btn_add_ad_data_user"
                                                                                class="btn btn-success btn-block btn-sm btn_add_data_user">
                                                        ...
                                                        <div class="tab-pane" id="note">
                                                            <div class="row mb-1">
                                                                <div class="col-md-3">
                                                                    @if ($canedit and auth()->user()->can('crear_categorias'))
                                                                        <button title="Agregar nota" id="bt_add_user_note"
