	...
	@slot('body')
     ...
     {{ csrf_field() }}
       ...
       <div class="form-group">
                    <label>Usar en</label>
                    <select class="form-control form-control-sm" name="categories" id="select_categories" data-placeholder="Seleccione..." style="width: 100%;">
       ...
       <div class="form-group content_section_users" id="content_section_users" style="display: none">
              <label>Sección</label>
              <select class="form-control form-control-sm" name="section" id="select_section_user" data-placeholder="Seleccione..." style="width: 100%;">
        ...
        <div class="row chkadoptions adoptions_g content_section_users" style="display: none">
          <div class="col-md-5">
            <div class="form-check form-check-inline " >
              <input class="form-check-input" type="checkbox" name="chk_add_option" id="chk_add_option" value="true">
              <label class="form-check-label" for="chk_add_option">Agregar opciones</label>
            </div>
          </div>
      
       <div class="col-md-7 content_section_users" style="display: none" id="sel_answer_type">
            <select required name="type_data_id" class="form-control form-control-sm">           
              <option value="58">Selección múltiple única respuesta</option>
              <option value="136">Selección múltiple varias respuesta</option>
            </select>
          </div> 
