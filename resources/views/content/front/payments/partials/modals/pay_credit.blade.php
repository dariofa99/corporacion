        ...
        <form action="" method="POST" id="myformPayCredits">
          ...
          <input type="hidden" readonly name="id" id="payment_credit_id">            
                                      ...
                                      <div class="row mp_options_pay">
                                        ...
                                        <div class="col">
                                          <div class="form-group">
                                             <select name="payment_method_id" disabled required class="form-control form-control-sm payment_method_id" id="payment_method_id">
                                ...
                                {{--   <div class="form-group des_url_pay" style="display:none">
                                         ...
                                         <input class="form-control form-control-sm"
                                            type="url" name="url" id="url" value="https://.https://biz.payulatam.com/"
                                            placeholder="https://example.com"
                                            pattern="https://.https://biz.payulatam.com/*" size="30"
                                            required>
                                  </div> --}}
                                   <div class="form-group des_button_pay" style="display:none">
                                          <label for="value">URL</label><br>
                                         <a href="#" id="button_pay" target="_blank" class="btn btn-primary btn-lg btn-sm">Ir al pago</a>
                                  </div>      
