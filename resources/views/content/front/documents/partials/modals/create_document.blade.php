	...
	@slot('body')
 	...
 	<div class="row">
		<div class="col-md-10 offset-md-1" id="content_form_cl">
         ...
         <form action="/log" method="POST" id="myformCreateClientLog" enctype="multipart/form-data">
             <input type="hidden" name="id" id="log_id"> 
             <input type="hidden" name="type_log_id" id="type_log_id">
             <input type="hidden" name="type_category_id" id="type_category_id" value="9">
     {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea required class="form-control form-control" name="description" id="description"  rows="3"></textarea> 
                            </div>

                         
                            <div class="form-group">
                            <div class="custom-file">
                                    <input required type="file" name="log_file" class="custom-file-input" id="logFile" >
