            ...
            <div class="col-md-10 offset-md-1" id="content_form_cl">
                ...
                <form method="POST" id="myformCreateDiary" enctype="multipart/form-data">
                        ...
                        <div class= "col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="timepicker1" data-target-input="nearest">
                                    <input type="text" required name="inicio" class="form-control datetimepicker-input"
                                        data-target="#timepicker1" id="input-date-picker1">
                        ...
                        <div class= "col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="timepicker2" data-target-input="nearest">
                                    <input type="text" required name="fin" class="form-control datetimepicker-input"
                                        data-target="#timepicker2" id="input-date-picker2">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="color" required name="color" id="input-color-diary" class="form-control input-lg"
                             value="#11a643" />
                       {{--  <div id="cp2" class="input-group" title="Using input value">
                            <input type="text" required name = "color" id="input-color-diary" class="form-control input-lg"
                                style="display:none;" value="#11a643" />
                            <span class="input-group-append">
                                <span class="input-group-text colorpicker-input-addon"><i id="color-diary"
                                        style="width: 200px;"></i></span>
                            </span>
                        </div> --}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2" name = "invitados[]" id="select2_users_diary" multiple="multiple"
                            data-placeholder="Seleccione invitados..." style="width: 100%;">
