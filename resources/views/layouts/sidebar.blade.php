...
<aside class="main-sidebar sidebar-{{ $sidebar_modo }}-primary elevation-4" style="background-color:#493d79">
    ...
    <a href="/home" class="brand-link" style="background-color: #ffffff;text-align: center;">
        <img src="{{ asset('/dist/img/Logo_horizontal.png') }}" alt="Lybra" class="img-fluid" style="width:80px">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <a href="/admin/users/{{ auth()->user()->id }}/edit" title="Ingresar a perfil">
                    <img src="{{ asset(auth()->user()->image) }}" id="image_profile_user_sidebar"
                        class="img-circle elevation-2 image_profile" alt="User Image">

                </a>
            </div>
            <div class="info">
                <a href="/admin/users/{{ auth()->user()->id }}/edit" id="name_profile_user_sidebar"
