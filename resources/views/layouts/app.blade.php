...
<div clas="row" style="text-align:center;margin:17px;">
    ...
    <footer class="footer">
      ...
      <div class="container container-footer" style="text-align:center;padding-bottom: 0px !important;">
            <img src="{{ asset('dist/img/recurso-26.png') }}" class="d-none d-sm-inline-block" style="width: 400px; margin-top:-144px;z-index: -1;position: absolute;margin-left: -200px;" alt="User Image">
